...
async function handleMessage(sock, msg) {
    try {
        ...
        // DEBUG: LOG ALL INCOMING TEXTS (HELPFUL FOR BUTTONS)
        if (msg.mtype === 'interactiveResponseMessage' || msg.mtype === 'buttonsResponseMessage') {
            console.log(`[Handler] 🔘 Interactive Response Detected: "${messageText}" (type: ${msg.mtype})`);
        }
        ...
        // 🚀 MODE CHECK (Bypass for owner and bot admins)
